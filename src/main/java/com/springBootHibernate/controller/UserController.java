...
public class UserController {
    ...
    public String helloWorld(){
        return "hello world, best wishes!";
    }
    ...
    public String pathVariable(@PathVariable("name")String name){
        ...
        return "helloworld, pathVariable's name" + name;
    }


    @RequestMapping(value = "mlc/{memberID}/SSOSession")
    public RestApiResult updateSession(@RequestBody SessionDomain sessionDomain, @PathVariable String memberID){
        try {
            User user = new User(sessionDomain.getMemberId(), sessionDomain.getAppCode());
            userDao.save(user);
